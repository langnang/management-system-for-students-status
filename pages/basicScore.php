    ...
    <body class="bg-3">
                                ...
                                <section class="tile color transparent-white">
                                    ...
                                    <div class="tile-body" id="studentImport">
                                        ...
                                        <form class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">学生成绩信息表</label>
                                                <div class="col-sm-10">
        ...
        <script>
            ...
            $(function () {
                ...
                $("#navigation").children("ul").children("li").eq(6).children("ul").children("li").eq(5).addClass("active");
