    ...
    <body class="bg-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile transparent" id="graduationAudit">
                                    ...
                                    <div class="tile-header transparent">
                                        <h1><strong>{{set.mark}}</strong> 学年毕业审核名单
                                        </h1>
                                        <div class="controls">
        ...
        <script>
            $(function () {
                ...
                $("#navigation").children("ul").children("li").eq(5).children("ul").children("li").eq(1).addClass("active");
...
//                                                console.log(msg);
                                                ...
                                                gra_vue.length=gra_vue.gra.length;
                                                gra_vue.page.min=1;
                                                gra_vue.page.max=gra_vue.gra.length;
                                            }
                                        });
                                    }
//                                    gra_vue.set = msg[0];
