    ...
    <body class="bg-3">
            ...
            <div class="row">
                ...
                <div id="content" class="col-md-12">
                    ...
                    <div class="pageheader">
                        ...
                        <h2><i class="fa fa-tachometer"></i> 高校学籍管理系统<span>基础信息设置</span></h2>
                                ...
                                <section class="tile color transparent-white">
                                    ...
                                    <div class="tile-body" id="studentImport">
                                        ...
                                        <form class="form-horizontal" role="form">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-btn">
                                                            <span class="btn btn-primary btn-file">
                                                                ...
                                                                <input type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" multiple="" onchange="importf(this)"  style="color: white;">
                                                            </span>
                                                        </span>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">基础课程信息表</label>
                                                <div class="col-sm-10">
        ...
        <script>
            ...
            $(function () {
                ...
                $("#navigation").children("ul").children("li").eq(6).children("ul").children("li").eq(3).addClass("active");
