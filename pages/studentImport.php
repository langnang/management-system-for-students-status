    ...
    <body class="bg-3">
                                    ...
                                    <div class="tile-body" id="studentImport">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table  class="table table-datatable table-custom text-center">
                                                ...
                                                <tbody>
                                                    <tr class="odd gradeX text-center" v-for="(i,index) in info">
                                                        <td>{{i.学号}}</td>
                                                        <td>{{i.姓名}}</td>
                                                        <td>{{i.性别}}</td>
                                                        <td>{{i.年龄}}</td>
        ...
        <script>
            ...
            $(function () {
                ...
                $("#navigation").children("ul").children("li").eq(1).children("ul").children("li").eq(2).addClass("active");
