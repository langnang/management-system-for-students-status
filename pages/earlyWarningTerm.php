                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumbs">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="earlyWarningSummary.php">学业预警</a></li>
                                <li class="active">预警名单</li>
                            </ol>
                        </div>
                    ...
                    <div class="main">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- tile -->
                                <section class="tile transparent" id="earlyWarning">


                                    <!-- tile header -->
                                    <div class="tile-header transparent" >
                                        <h1><strong>{{set.mark}}</strong> 学期预警
                                        </h1>
                                        <div class="controls">
                                            ...
                                            <table  class="table table-datatable table-custom text-center">
                                                <thead>
                                                    <tr class="">
                                                        ...
                                                        <th class="sort-alpha text-center">应获学分</th>
                                                        <th class="sort-alpha text-center">已获学分</th>
                                                        <th class="sort-alpha text-center">操作</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr class="odd gradeX" v-for="(e,index) in ear">
                                                        <td>{{e.id_student}}</td>
                                                        <td>{{e.credits}}</td>
                                                        <td>{{e.acquired}}</td>
                ...
                var eaw_vue = new Vue({
                    ...
                    watch:{
                        set:function(){
                            ...
                            $.ajax({
                                url: "../action/ctsview_selectByMark.php",
                                data: {mark: mark},
                                type: "post",
                                dataType: "json",
                                success: function (msg) {
